...
if "django.contrib.admin" in settings.INSTALLED_APPS:
    urlpatterns += [
        url("^password_reset/$", auth_views.PasswordResetView,
            name="password_reset"),
        url("^password_reset/done/$", auth_views.PasswordResetDoneView,
            name="password_reset_done"),
        url("^reset/done/$", auth_views.PasswordResetCompleteView,
